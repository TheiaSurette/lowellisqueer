...
const WORD_POOL: WordEntry[] = [
  ...
  {
    word: "Polyamorous",
    colors: ["#009FE3", "#FFFFFF", "#FCBF00", "#E50051", "#340C46"],
  },
  {
    word: "Transfem",
    colors: ["#73DEFF", "#FFE1ED", "#FFB5D6", "#FFE1ED", "#73DEFF"],
  },
  {
    word: "Transmasc",
    colors: ["#FF8ABD", "#CDF5FE", "#9AEBFF", "#CDF5FE", "#FF8ABD"],
  },
  {
    word: "Sapphic",
    colors: ["#FD8BA8", "#FBF2FF", "#FFFFFF", "#C76BC5", "#FDD768"],
  },
...
export function HeroWordCycle() {
  ...
  return <span style={gradientStyle}>{displayText || "\u200B"}</span>
}
